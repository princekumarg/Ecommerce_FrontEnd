...
const StyleAutoComplete=styled(Autocomplete)(({theme})=>({
      ...
      width:"100%",
      "& .MuiTextField-root":{
        paddingRight:`calc(len*${theme.spacing(4)})`
      },
      "& .MuiInputBase-input":{
...
function SearchBar(){
  ...
  return (
    <Search>
      <Select value={selectedCategory} size="small" sx={{
        m:1,
      ...
      }} variant='standard' labelId='selected-category' id='selected-category-id' onChange={handleCategoryChange}>
